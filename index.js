...
var databaseUri = 'mongodb://heroku_vckrmjdz:tukl1rpk9l7gsvjgp45qbc189a@ds023052.mlab.com:23052/heroku_vckrmjdz';
...
var api = new ParseServer({
  ...
  appId: process.env.APP_ID || 'parse7fo46ds9fv3s4',
  masterKey: process.env.MASTER_KEY || 'f6ss1v3s48a38hg4gt8', //Add your master key here. Keep it secret!
  ...
  publicServerURL: 'https://cheers1.herokuapp.com/parse',
  ...
  passwordPolicy: {
    ...
    validatorPattern: /^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.{8,16})/, // enforce password with at least 8 char with at least 1 lower case, 1 upper case and 1 digit
